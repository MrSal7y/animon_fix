...
The config screen lets you turn off Pokemon ambient sounds, disable missing-cry fallbacks, or use a simple Default Cobblemon Mode preset that turns both of those extras off. Missing-cry fallbacks only affect Pokemon where Cobblemon has a cry animation but no sound keyframe.
